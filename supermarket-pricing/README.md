...
recommend [Gfm](https://plugins.jetbrains.com/plugin/7701?pr=clion)). It will render properly the class diagram generated by [Gravizo](http://www.gravizo.com), which might be useful to help to understand the design.
